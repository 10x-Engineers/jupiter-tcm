...
void test_mmt4d_tcm_parallel(int** result, int8_t** lhs, int8_t** rhs, size_t M, size_t N, size_t K, size_t M0, size_t N0, size_t K0, size_t number_of_workers) {
    size_t M1 = M / M0;
    size_t N1 = N / N0;
    size_t K1 = K / K0;
    ...
    printf("Number of RHS panels: %zu\n", N1);
    ...
    mmt4d_tcm_thread_arg_t args[number_of_workers];

    size_t N1_per_thread = N1 / number_of_workers;
    size_t N1_remainder = N1 % number_of_workers;
...
void test_mmt4d_parallel(int** result, int8_t** lhs, int8_t** rhs, size_t M, size_t N, size_t K, size_t M0, size_t N0, size_t K0, size_t number_of_workers) {
    size_t M1 = M / M0;
    size_t N1 = N / N0;
    size_t K1 = K / K0;
    ...
    pthread_t threads[number_of_workers];
    mmt4d_thread_arg_t args[number_of_workers];
...
int main(int agrc, char* argv[]) {
    ...
    size_t number_of_workers = atoi(argv[7]);
    ...
    test_mmt4d_parallel(res_mmt4d, lhs, rhs, M, N, K, M0, N0, K0, number_of_workers);
    test_mmt4d_tcm_parallel(res_mmt4d_tcm, lhs, rhs, M, N, K, M0, N0, K0, number_of_workers);
