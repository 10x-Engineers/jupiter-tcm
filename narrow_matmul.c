...
void test_mmt4d_tcm(int** result, int8_t** lhs, int8_t** rhs, size_t M, size_t N, size_t K, size_t M0, size_t N0, size_t K0) {
    ...
    mmt4d_s8s8s32_tcm_narrow(lhs_packed, rhs_t_packed, res_packed, rhs_t_packed_tcm, M1, N1, K1, M0, N0, K0, total_rhs_panels_to_prefetch);
...
void test_mmt4d(int** result, int8_t** lhs, int8_t** rhs, size_t M, size_t N, size_t K, size_t M0, size_t N0, size_t K0) {
    ...
    flush_cache();
    clock_gettime(CLOCK_MONOTONIC, &start);
    mmt4d_s8s8s32_narrow(lhs_packed, rhs_t_packed, res_packed, M1, N1, K1, M0, N0, K0);
    clock_gettime(CLOCK_MONOTONIC, &end);
...
int main(int agrc, char* argv[]) {
    ...
    compare(res_matmul, res_mmt4d_tcm, M, N);
